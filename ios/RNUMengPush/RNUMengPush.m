...
static RNUMengPush *PUSH_INSTANCE = nil;
static NSDictionary *LAUNCH_OPTIONS = nil;

RCT_EXPORT_MODULE(RNUMengPush);
...
+ (void)didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken {
    ...
    if ([LAUNCH_OPTIONS objectForKey:UIApplicationLaunchOptionsRemoteNotificationKey]) {
        ...
        body = [RNUMengPush getNotification:userInfo];
    }
    else {
...
+ (void)didReceiveRemoteNotification:(NSDictionary *)userInfo fetchCompletionHandler:(void (^)(UIBackgroundFetchResult))completionHandler {
    NSMutableDictionary *body = [RNUMengPush getNotification:userInfo];
...
+ (NSMutableDictionary *)getNotification:(NSDictionary *)userInfo {
    NSDictionary *custom = [RNUMengPush getCustom:userInfo];
